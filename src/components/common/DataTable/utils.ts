...
export const getStickyClass = (sticky?: "left" | "right") => {
  ...
  if (sticky === "left") {
    return "sticky left-0 z-10 bg-inherit border-r border-line shadow-[4px_0_6px_-4px_rgb(30_21_38_/_0.12)]";
  }
  if (sticky === "right") {
    return "sticky right-0 z-10 bg-inherit border-l border-line shadow-[-4px_0_6px_-4px_rgb(30_21_38_/_0.12)]";
  }
  return "";
};
